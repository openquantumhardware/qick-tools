...
set clk_adc1 [get_clocks -of_objects [get_nets -of_objects [get_pins d_1_i/usp_rf_data_converter_0/clk_adc1]]]
...
set_clock_group -name clk_axi_to_adc1 -asynchronous \
    -group [get_clocks $clk_axi] \
    -group [get_clocks $clk_adc1]        
