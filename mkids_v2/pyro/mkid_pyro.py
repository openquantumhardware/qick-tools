...
def start_server(ns_host, ns_port=8888, proxy_name='mkidrfsoc', **kwargs):
    ...
    ## This is where you have to instantiate the Scan object
    scan = Scan.Scan(**kwargs)
    print("initialized Scan")
    ...
    ns.register(proxy_name, daemon.register(scan))
